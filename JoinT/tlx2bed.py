...
def parse_args():
    ...
    parser.add_argument("-g", dest = "genome", type = str, choices={'mm9', 'mm10', 'hg19', 'hg38'},
...
def parseFILE(args):
    ...
    if args.genome == 'mm9':
        genomefile = '{0}/chromInfo_mm9.txt'.format(fullpath)
    elif args.genome == 'mm10':
        genomefile = '{0}/chromInfo_mm10.txt'.format(fullpath)
    elif args.genome == 'hg19':
        genomefile = '{0}/chromInfo_hg19.txt'.format(fullpath)
    elif args.genome == 'hg38':
        genomefile = '{0}/chromInfo_hg38.txt'.format(fullpath)
